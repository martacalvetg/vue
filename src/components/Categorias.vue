<template>
    <li v-for="categoria in categorias" :categorias="categorias" class="nav-link categories-products-grid__category"
        id="v-pills-categories-skincare-tab" data-bs-toggle="pill" data-bs-target="#v-pills-categories-skincare"
        aria-selected="true">
        <span>{{ categoria }}</span>
    </li>
</template>
