    ...
    <div id="carouselFeatured" class="carousel carousel-dark slide carousel-featured" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="3000">
            <img src="src\assets\images\featured\featured_clean.png" class="d-block" alt="...">
          ...
          <div class="carousel-item" data-bs-interval="3000">
            <img src="src\assets\images\featured\featured_iphone.png" class="d-block" alt="...">
            <div class="carousel-caption d-md-block">
              <h5>New iPhone</h5>
          ...
          <div class="carousel-item" data-bs-interval="3000">
            <img src="src\assets\images\featured\featured_laptop.png" class="d-block" alt="...">
            <div class="carousel-caption d-md-block">
