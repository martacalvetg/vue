<template>
    <nav class="navbar navbar-light navbar-header">
        <div class="container">
            <div class="logo">
            <a href="/">
                <img src="src\assets\images\logos\logo.png" class="img-fluid logo-img logo-img--full" alt="logo">
                <img src="src\assets\images\logos\icon.svg" class="img-fluid logo-img logo-img--mobile" alt="logo">
            </a>
            </div>
            <form class="search">
            ...
            <div class="user-options__item">
                <router-link to="/"><font-awesome-icon :icon="['fas', 'cart-shopping']" size="xl" /></router-link>
            </div>
            <div class="user-options__item">
                <router-link to="/login"><font-awesome-icon :icon="['fas', 'user']" size="xl" /></router-link>
            </div>
            </div>
        </div>
    </nav>
...
<style>
    ...
    .product-card {
        ...
        height: 325px;
        border-radius: 10px;
        box-shadow: 10px 10px 26px -21px rgba(0,0,0,0.75);
        overflow: hidden;
